...
*   ^[[PHP 8.0.0 alpha2](https://wiki.php.net/rfc/match_expression_v2)]^ `match` 现在是一个保留字。

*   ^[[PHP 8.0.0](https://wiki.php.net/rfc/match_expression_v2)]^ 断言（Assertion）失败现在默认抛出异常。如果想要改回之前的行为，可以在 INI 设置中设置 `assert.exception=0` 。
